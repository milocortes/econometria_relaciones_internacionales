...
# ╔═╡ f5664d1a-67c8-4815-9c8a-d04dd3bfaa19
begin
	...
	@bind bin_num Slider(10:10:300, default=10)
...
* Usamos distribuciones de probabilidad para cuantificar la incertidumbre (Kochenderfer et al, 2022).
...
* Podemos representar tal distribución como una *función de probabilidad* la cual asigna una probabilidad a cada evento posible. Esta función de probabilidad toma como entrada una variable $X$ que puede tomar uno de los $n$ eventos posibles.
...
# ╔═╡ f73f81b1-2a14-40b1-8dc1-e824fd17f19b
md"""
...
# ╔═╡ 89bff61c-18d8-45a4-86d1-5beebd4b64a3
begin 
	normal_truncada = Distributions.Truncated(Normal(7, 3.5), 1, 10)
	x = rand(normal_truncada, 10000)
	h = fit(Histogram, x, nbins=bin_num)
	probs = h.weights./sum(h.weights)
	p = bar(collect(h.edges[1])[2:end],probs)
	ylabel!("Probabilidad")
	xlabel!("Calificación")
	title!("Probabilidad de obtención de calificación")
end

# ╔═╡ 532230e6-90ef-4244-bb1c-a3ddc7b06869
md"""
...
# ╔═╡ 581b707f-f83f-46fd-b28a-bd3f7804f5ad
md"""
## Distribución de Probabilidad Uniforme
...
# ╔═╡ 9a74297c-5ff7-4f94-adae-7f1ef5da63ca
@bind a_uniforme NumberField(0:100, default=20)

# ╔═╡ b4d16aab-11c6-4189-8f50-210f907ab6b8
md"""
Selecciona valor de $b$
"""

# ╔═╡ 24f556a6-eba8-4855-8296-8ebd5eda564d
@bind b_uniforme NumberField(0:100, default=60)

# ╔═╡ c22b663e-b1c7-4071-b1ca-ee249629e902
begin
		
	uniforme_rango = a_uniforme-20:0.001:b_uniforme+20
	plot(uniforme_rango, pdf.(Uniform(a_uniforme,b_uniforme), uniforme_rango), label="Distribución")
	xlabel!("Rango")
	ylabel!("Densidad de probabilidad")
	xlims!(a_uniforme-20, b_uniforme+20)
end

# ╔═╡ 56defa28-fb34-4849-8f25-a5dae5d03f1f
md"""
...
Selecciona valor de $\mu$ = $(mu_slider)
"""
...
md"""
Selecciona valor de $\sigma^2$ = $(sigma_slider)
"""
...
# ╔═╡ 915efb80-7d18-483b-ad89-706abf4f1df9
md"""
...
# ╔═╡ 9630fa6b-52d1-4cbd-8788-e599666c5b49
md"""
...
# ╔═╡ c5b188ad-e320-4019-91a1-febac528e81e
md"""
...
* La variable aleatoria $X_3$ modela la distribución de los precios de vivienda en la colonia Napoles la cual tiene parámetros $N(1,4)$.
"""
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "cf0ff6fe4621c1cfd3c84d2213f2afc2daa02588"
